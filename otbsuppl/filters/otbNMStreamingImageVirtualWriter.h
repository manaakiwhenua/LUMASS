...
******************************************************************************/
#ifndef __otbNMStreamingImageVirtualWriter_h
...
public:
  ...
  typedef NMStreamingImageVirtualWriter                          Self;
  ...
  itkTypeMacro(NMStreamingImageVirtualWriter, itk::ImageToImageFilter);
  ...
  typedef typename OutputImageType::PixelContainer OutputContainerType;
...
//#endif
  ...
  /** Set the number of threads used by this filter */
...
protected:
  ...
  virtual ~NMStreamingImageVirtualWriter();
...
private:
  ...
  void operator =(const NMStreamingImageVirtualWriter&); //purposely not implemented
...
#include "otbNMStreamingImageVirtualWriter.txx"
#endif
