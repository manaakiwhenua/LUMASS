...
/*!
 *  adapted by Alex Herzig for use in LUMASS, September 2020
 *  (c) 2020, Landcare Research New Zealand Ltd.
 *
*/


#ifndef NMVtkOpenGLPolyDataMapper2_h
#define NMVtkOpenGLPolyDataMapper2_h
...
class NMVtkOpenGLPolyDataMapper2 : public vtkPolyDataMapper
{
public:
  static NMVtkOpenGLPolyDataMapper2* New();
  vtkTypeMacro(NMVtkOpenGLPolyDataMapper2, vtkPolyDataMapper);
...
protected:
  NMVtkOpenGLPolyDataMapper2();
  ~NMVtkOpenGLPolyDataMapper2() override;
  ...
  //=======================================================================
  /** added by alex to support polygon tesselation **/
  void UpdateColorMapping();
  void PrintLookupTable(vtkLookupTable* lut, std::string label);

  std::vector<vtkIdType> TriIdsToPolyIds;
  vtkMTimeType LastColorChange;

  vtkSmartPointer<vtkPolyData> m_Tris;
  vtkSmartPointer<vtkPolyData> m_OrigInput;
...
private:
  NMVtkOpenGLPolyDataMapper2(const NMVtkOpenGLPolyDataMapper2&) = delete;
  void operator=(const NMVtkOpenGLPolyDataMapper2&) = delete;
};
