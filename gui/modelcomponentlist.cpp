        ...
        if (!fileName.isEmpty())
        {
            ...
            if (tabFormats.contains(ext))
            {
                ...
                if (sqliteformats.contains(ext))
                {
                    ...
                    {
                        mainWin->importTable(fileName, OtbModellerWin::NM_TABVIEW_STANDALONE, true, tableName);
                    }
                }
                else
                {
                    mainWin->importTable(fileName, OtbModellerWin::NM_TABVIEW_STANDALONE, true);
                }
            }
