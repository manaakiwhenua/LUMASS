 ...
 ******************************************************************************/
/*
 * NMJSKernelFilterWrapperFactory.h
 *
 *  Created on: 2019-12-24
 *      Author: Alex
 */

#ifndef NMJSKernelFilterWrapperFactory_H_
#define NMJSKernelFilterWrapperFactory_H_
...
class NMJSKERNELFILTERWRAPPER_EXPORT NMJSKernelFilterWrapperFactory : public NMWrapperFactory
{
    Q_OBJECT
public:
    NMJSKernelFilterWrapperFactory(QObject *parent = nullptr);
