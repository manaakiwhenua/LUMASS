/*=========================================================================
  ...
  Module:    NMVtkQtTableModelAdapter.h
...
-------------------------------------------------------------------------*/
// .NAME NMVtkQtTableModelAdapter - Adapts a table to a Qt item model.
//
// .SECTION Description
// NMVtkQtTableModelAdapter is a QAbstractItemModel with a vtkTable as its
...
#ifndef __NMVtkQtTableModelAdapter_h
#define __NMVtkQtTableModelAdapter_h
...
class QVTK_EXPORT NMVtkQtTableModelAdapter : public NMVtkQtAbstractModelAdapter
{
  Q_OBJECT

public:
  NMVtkQtTableModelAdapter(QObject *parent = 0);
  NMVtkQtTableModelAdapter(vtkTable* table, QObject *parent = 0);
  ~NMVtkQtTableModelAdapter();
...
private:
  ...
  NMVtkQtTableModelAdapter(const NMVtkQtTableModelAdapter &);  // Not implemented
  void operator=(const NMVtkQtTableModelAdapter&);  // Not implemented.
};
