 ...
 ******************************************************************************/
/*
 * NMStreamingROIImageFilterWrapper.h
 *
 *  Created on: 2019-05-16
 *      Author: Alexander Herzig
 */

#ifndef NMStreamingROIImageFilterWrapper_H_
#define NMStreamingROIImageFilterWrapper_H_
		...
		: public NMProcess
{
    ...
    Q_PROPERTY(QList<QStringList> ROILength READ getROILength WRITE setROILength)
...
public:
    ...
    NMPropertyGetSet( ROILength, QList<QStringList> )
...
protected:
    ...
    QList<QStringList> mROILength;

};

#endif /* NMStreamingROIImageFilterWrapper_H_ */
