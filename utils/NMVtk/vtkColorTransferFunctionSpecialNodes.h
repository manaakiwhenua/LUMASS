/*=========================================================================
  ...
  Module:    vtkColorTransferFunctionSpecialNodes.h
...
=========================================================================*/
// .NAME vtkColorTransferFunctionSpecialNodes - Defines a transfer function for mapping a property to an RGB color value.

// .SECTION Description
// vtkColorTransferFunctionSpecialNodes is a color mapping in RGB or HSV space that
...
#ifndef __vtkColorTransferFunctionSpecialNodes_h
#define __vtkColorTransferFunctionSpecialNodes_h
...
public:
  ...
  vtkTypeMacro(vtkColorTransferFunctionSpecialNodes,vtkScalarsToColors);
  void DeepCopy( vtkScalarsToColors *f );
  void ShallowCopy( vtkColorTransferFunctionSpecialNodes *f );
  ...
  void setSpecialNode(int id, double value, std::vector<double> rgba);
  std::vector< std::vector<double> >& getSpecialColours(void)
		{return this->SpecialColours;}
  std::vector<double>& getSpecialValues(void) {return this->SpecialValues;}




protected:
  vtkColorTransferFunctionSpecialNodes();
  ~vtkColorTransferFunctionSpecialNodes();

  vtkColorTransferFunctionSpecialNodesInternals *Internal;
  ...
  // Alex's Hack
  std::vector< std::vector<double> > SpecialColours;
...
private:
  vtkColorTransferFunctionSpecialNodes(const vtkColorTransferFunctionSpecialNodes&);  // Not implemented.
  void operator=(const vtkColorTransferFunctionSpecialNodes&);  // Not implemented.
};
