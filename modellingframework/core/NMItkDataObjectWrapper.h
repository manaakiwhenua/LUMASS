...
public:
    ...
    enum NMComponentType {NM_UNKNOWN, NM_UCHAR, NM_CHAR, NM_USHORT, NM_SHORT,
        NM_UINT, NM_INT, NM_ULONG, NM_LONG, NM_ULONGLONG, NM_LONGLONG, NM_FLOAT, NM_DOUBLE, NM_STRING};
    ...
    bool getIsStreaming(){return this->mbIsStreaming;}
...
protected:
    ...
    itk::ProcessObject::Pointer mItkProcess;
    ...
    void setupBufferFilter();

    itk::DataObject* getBufferFilterOutput();
    void createBufferFilterInstance();
    void setBufferFilterInput();
