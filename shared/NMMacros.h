...
#define callSingleTypeCreator( inputType, wrapName ) \
{ \
	if (this->mInputNumDimensions == 1)		\
	{		\
...
//#define MacroPerType( macroName, wrapName ) \
//	case itk::ImageIOBase::UCHAR:                                               \
//		outputTypeSwitch( unsigned char, macroName, wrapName );                                         \
//		break;                                                                  \
//	case itk::ImageIOBase::CHAR:                                                \
//		outputTypeSwitch( char, macroName, wrapName );                                                  \
//		break;                                                                  \
//	case itk::ImageIOBase::USHORT:                                              \
//		outputTypeSwitch( unsigned short, macroName, wrapName );                                        \
//		break;                                                                  \
//	case itk::ImageIOBase::SHORT:                                               \
//		outputTypeSwitch( short, macroName, wrapName );                                                 \
//		break;                                                                  \
//	case itk::ImageIOBase::UINT:                                                \
//		outputTypeSwitch( unsigned int, macroName, wrapName );                                          \
//		break;                                                                  \
//	case itk::ImageIOBase::INT:                                                 \
//		outputTypeSwitch( int, macroName, wrapName );                                                   \
//		break;                                                                  \
//	case itk::ImageIOBase::ULONG:                                               \
//		outputTypeSwitch( unsigned long, macroName, wrapName );                                         \
//		break;                                                                  \
//	case itk::ImageIOBase::LONG:                                                \
//		outputTypeSwitch( long, macroName, wrapName );                                                  \
//		break;                                                                  \
//	case itk::ImageIOBase::FLOAT:                                               \
//		outputTypeSwitch( float, macroName, wrapName );                                                 \
//		break;                                                                  \
//	case itk::ImageIOBase::DOUBLE:                                              \
//		outputTypeSwitch( double, macroName, wrapName );                                                \
//		break;
...
{                                                                       \
	...
	switch (this->mOutputComponentType)                                 \
	{                                                                   \
	MacroPerType( callSingleTypeCreator, WrapName)                       \
	default:                                                            \
		init = false;                                                   \
		break;                                                          \
	}                                                                   \
