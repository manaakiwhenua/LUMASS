...
/*!
 *  adapted by Alex Herzig for use in LUMASS, December 2018
 *  (c) 2018, Landcare Research New Zealand Ltd.
 *
*/

#ifndef NMVtkOpenGLPolyDataMapper_h
#define NMVtkOpenGLPolyDataMapper_h
...
class NMVtkOpenGLPolyDataMapper : public vtkPolyDataMapper
{
public:
  static NMVtkOpenGLPolyDataMapper* New();
  vtkTypeMacro(NMVtkOpenGLPolyDataMapper, vtkPolyDataMapper)
...
protected:
  NMVtkOpenGLPolyDataMapper();
  ~NMVtkOpenGLPolyDataMapper() override;
  ...
  // store the from TrisIds to PolyIDs
...
private:
  NMVtkOpenGLPolyDataMapper(const NMVtkOpenGLPolyDataMapper&) = delete;
  void operator=(const NMVtkOpenGLPolyDataMapper&) = delete;
};
