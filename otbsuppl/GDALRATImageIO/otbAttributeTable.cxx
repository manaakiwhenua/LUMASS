...
bool
AttributeTable::dropTable(const std::string &tablename)
{
    NMDebugCtx(_ctxotbtab, << "...");
...
void
AttributeTable::disconnectDB(void)
{
    if (m_db != 0)
    {
        sqlite3_close(m_db);
...
void
AttributeTable::resetTableAdmin(void)
{
    // clean up
...
void
AttributeTable::closeTable(bool drop)
{
    if (drop)
    {
        this->dropTable();
