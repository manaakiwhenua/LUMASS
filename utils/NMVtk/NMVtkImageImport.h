...
/*
    ...
    - added support for 'long long' and 'unsigned long long' data type
    by Alexander Herzig - August 2020

*/

#ifndef NMVtkImageImport_h
#define NMVtkImageImport_h

//#include "vtkIOImageModule.h" // For export macro
#include "vtkImageAlgorithm.h"

class NMVtkImageImport : public vtkImageAlgorithm
{
public:
  static NMVtkImageImport *New();
  vtkTypeMacro(NMVtkImageImport,vtkImageAlgorithm);
   ...
   * when the NMVtkImageImport object is deallocated.  VTK will not make its
...
private:
  NMVtkImageImport(const NMVtkImageImport&) = delete;
  void operator=(const NMVtkImageImport&) = delete;
};
